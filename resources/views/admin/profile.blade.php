                ...
                <div class="col-xl-12" style="background:#fff">
                    <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card mb-4">
                                    <form action="{{ route('profile.update', ['section' => 'basic']) }}" method="POST">
                                        @csrf
                                ...
                                <div class="card mb-4">
                                    <form action="{{ route('profile.update', ['section' => 'contact']) }}" method="POST">
                                        @csrf
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="card mb-4">
                                    <form action="{{ route('profile.update', ['section' => 'professional']) }}" method="POST">
                                        @csrf
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="card mb-4">
                                    <form action="{{ route('profile.update', ['section' => 'social']) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5>Social & Media</h5>
                                ...
                                <div class="card mb-4">
                                    <form action="{{ route('profile.update', ['section' => 'details']) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <!-- Section 6: Hobbies -->
                                <div class="card mb-4">
                                    <form action="{{ route('profile.update', ['section' => 'hobbies']) }}" method="POST">
                                        @csrf
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5>Hobbies</h5>
