    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label>Wholesale</label><br>
                    <input type="checkbox" name="is_wholesale" value="1" @if($product->is_wholesale) checked @endif> Wholesale?
                    <input type="number" name="min_qty" placeholder="Min Qty" value="{{ $product->min_qty }}" class="form-control mt-2">
                    <input type="number" name="wholesale_price" placeholder="Wholesale Price" step="0.01" value="{{ $product->wholesale_price }}" class="form-control mt-2">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="checkbox" name="is_approved" value="1" @if($product->is_approved) checked @endif> Approve?
                </div>
